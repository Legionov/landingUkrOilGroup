...
$(document).ready(function () {
  $('.menu-tabs .anchor').tab();
// 00000
  const pilih = (s) => document.querySelector(s);

//hide show nav onclick

//hide/show drpdown onclick
  pilih('.dropdown-toggle').addEventListener('click',(e)=>{
    e.preventDefault();
    pilih('.sub-menu').classList.toggle('show-dropdown');
  });
// 00000
  ...
  $('.button-open-search').click(function () {
    $(this).closest(".header").find('.search').toggleClass('is-open');
  });
  ...
  $(".btn-more").click(function () {
    $(this).closest(".js-projects-list").addClass('show-all');
  });


  $(".js-category-title").click(function () {
    $(this).closest(".js-category-wrap").toggleClass('is-open');
  });
  $(".btn-menu").click(function () {
